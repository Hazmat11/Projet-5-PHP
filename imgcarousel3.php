...
$sql = "UPDATE projet SET carousel1 = 'img/$varImg1' WHERE id = 3";
$pre = $pdo->prepare($sql);
$pre->execute();
$sql = "UPDATE projet SET carousel2 = 'img/$varImg2' WHERE id = 3";
$pre = $pdo->prepare($sql);
$pre->execute();
$sql = "UPDATE projet SET carousel3 = 'img/$varImg3' WHERE id = 3";
$pre = $pdo->prepare($sql);
$pre->execute();
